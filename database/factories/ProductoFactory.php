...
class ProductoFactory extends Factory
{
    ...
    public function definition() {
        ...
        // Treamos una categoria de manera aleatoria de la y la convertimos en un objeto de PHP
        $categoria = Categoria::inRandomOrder()->first();
        
        return [
            'nombre' => $this->faker->sentence(), // Una linea aleatoria
            'descripcion' => $this->faker->paragraph(), // Un párrafo aleatorio
            'precio' => $this->faker->randomFloat(2, 2000, 100000), // Nro Flotante aleatorio en el rango [2000, 100000] con 2 decimales
